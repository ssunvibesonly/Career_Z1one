...
<body>
	...
	<button class="custom-btn btn-8" style="position: absolute; right: 200px; top:30px; width: 70px; height: 32px; padding: -5px 0px;" onclick="location.href='/login/form'" ><span style="font-size: 0.8em; ">로그인</span></button>
	 </c:if>
	 <c:if test="${sessionScope.loginok!=null || sessionScope.companyloginok!=null }">
	<button class="custom-btn btn-8" style="position: absolute; right: 200px; top:30px; width: 70px; height: 32px; padding: -5px 0px;" onclick="location.href='/login/logoutaction'"><span style="font-size: 0.8em; ">로그아웃</span></button>
	</c:if>
</body>
</html>